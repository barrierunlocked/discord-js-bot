...
module.exports = {
  ...
  async messageRun(message) {
    ...
    try {
      ...
      console.error(err);
      return message.safeReply("Sorry, I couldn't get a hentai image at the moment.");
    }
  },
  ...
  async interactionRun(interaction) {
    ...
    try {
      ...
      console.error(err);
      return interaction.followUp({ content: "Sorry, I couldn't get a hentai image at the moment.", ephemeral: true });
    }
  },
};

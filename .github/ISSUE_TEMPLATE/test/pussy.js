...
module.exports = {
  name: "pussy",
  description: "Send a random NSFW pussy image.",
  cooldown: 5,
  category: "NSFW",
  ...
  async messageRun(message) {
    ...
    try {
      ...
      console.error(err);
      return message.safeReply("Sorry, I couldn't get a pussy image at the moment.");
    }
  },
  ...
  async interactionRun(interaction) {
    ...
    try {
      ...
      console.error(err);
      return interaction.followUp({ content: "Sorry, I couldn't get a pussy image at the moment.", ephemeral: true });
    }
  },
};

...
module.exports = {
  name: "hkitsune",
  description: "Send a random NSFW hkitsune image.",
  cooldown: 5,
  category: "NSFW",
  ...
  async messageRun(message) {
    ...
    try {
      ...
      console.error(err);
      return message.safeReply("Sorry, I couldn't get a hkitsune image at the moment.");
    }
  },
  ...
  async interactionRun(interaction) {
    ...
    try {
      ...
      console.error(err);
      return interaction.followUp({ content: "Sorry, I couldn't get a hkitsune image at the moment.", ephemeral: true });
    }
  },
};

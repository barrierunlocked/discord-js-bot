...
module.exports = {
  name: "holo",
  description: "Send a random NSFW holo image.",
  cooldown: 5,
  category: "NSFW",
  ...
  async messageRun(message) {
    ...
    try {
      const res = await fetch("https://nekobot.xyz/api/image?type=holo");
      ...
      console.error(err);
      return message.safeReply("Sorry, I couldn't get a holo image at the moment.");
    }
  },
  ...
  async interactionRun(interaction) {
    ...
    try {
      ...
      console.error(err);
      return interaction.followUp({ content: "Sorry, I couldn't get a holo image at the moment.", ephemeral: true });
    }
  },
};

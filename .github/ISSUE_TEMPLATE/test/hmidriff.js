...
module.exports = {
  name: "hmidriff",
  description: "Send a random NSFW hmidriff image.",
  cooldown: 5,
  category: "NSFW",
  ...
  async messageRun(message) {
    ...
    try {
      const res = await fetch("https://nekobot.xyz/api/image?type=hmidriff");
      ...
      console.error(err);
      return message.safeReply("Sorry, I couldn't get a hmidriff image at the moment.");
    }
  },
  ...
  async interactionRun(interaction) {
    ...
    try {
      ...
      console.error(err);
      return interaction.followUp({ content: "Sorry, I couldn't get a hmidriff image at the moment.", ephemeral: true });
    }
  },
};

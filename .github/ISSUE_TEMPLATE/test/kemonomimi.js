...
module.exports = {
  name: "kemonomimi",
  description: "Send a random NSFW kemonomimi image.",
  cooldown: 5,
  category: "NSFW",
  ...
  async messageRun(message) {
    ...
    try {
      const res = await fetch("https://nekobot.xyz/api/image?type=kemonomimi");
      ...
      console.error(err);
      return message.safeReply("Sorry, I couldn't get a kemonomimi image at the moment.");
    }
  },
  ...
  async interactionRun(interaction) {
    ...
    try {
      ...
      console.error(err);
      return interaction.followUp({ content: "Sorry, I couldn't get a kemonomimi image at the moment.", ephemeral: true });
    }
  },
};

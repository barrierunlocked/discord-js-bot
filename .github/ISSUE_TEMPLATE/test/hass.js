...
module.exports = {
  name: "hass",
  description: "Send a random NSFW hass image.",
  cooldown: 5,
  category: "NSFW",
  ...
  async messageRun(message) {
    ...
    try {
      ...
      console.error(err);
      return message.safeReply("Sorry, I couldn't get a hass image at the moment.");
    }
  },
  ...
  async interactionRun(interaction) {
    ...
    try {
      ...
      console.error(err);
      return interaction.followUp({ content: "Sorry, I couldn't get a hass image at the moment.", ephemeral: true });
    }
  },
};
